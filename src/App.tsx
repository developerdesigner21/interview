  ...
  return (
    <div className={classes.body}>
      <Container maxWidth="xl">
        <h1 className={classes.heading_text}>Coding Challenge</h1>
      </Container>
      <Divider className={classes.divider} />
      <Container maxWidth="xl">
        <div className={classes.global_action_section}>
          <Button onClick={() => setMessages([])} variant="contained" className={classes.action_clear}>
            Clear
          </Button>
          <Button 
            onClick={() => {
          ...
          <Grid container spacing={2}>
            <Grid item xs={4}>
              ...
              {messages
                ...
                .map((ele,index) => {
                  return (
                    <div className={classes.error_block} key={index}>
